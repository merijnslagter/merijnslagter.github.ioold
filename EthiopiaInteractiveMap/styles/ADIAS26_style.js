...
var styleCache_ADIAS26={}
var style_ADIAS26 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    if (!styleCache_ADIAS26[key]){
        ...
        styleCache_ADIAS26[key] = new ol.style.Style({"text": text})
    }
    var allStyles = [styleCache_ADIAS26[key]];
