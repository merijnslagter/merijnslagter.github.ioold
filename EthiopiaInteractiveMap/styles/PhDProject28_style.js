...
var styleCache_PhDProject28={}
var style_PhDProject28 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    if (!styleCache_PhDProject28[key]){
        ...
        styleCache_PhDProject28[key] = new ol.style.Style({"text": text})
    }
    var allStyles = [styleCache_PhDProject28[key]];
